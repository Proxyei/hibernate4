...
public class TestOne2One extends HibernateTest {
	...
	public void testDelete() {
		...
		// Manager manager = (Manager) session.get(Manager.class,
		// "297ebf926ae3926e016ae392701f0000");
		//
		// session.delete(manager);
		// Department department = (Department) session.get(Department.class,
		// "297ebf926ae397a6016ae397d25a0000");
	...
	public void testGet() {
		// Manager manager = (Manager) session.get(Manager.class,
		// "297ebf926ae3926e016ae392701f0000");
		// System.out.println("经理：" + manager.getManagerName() + "部门是" +
		// manager.getDepartment().getDeptName());
	...
	public void testQueryCache() {
		...
		List<Department> departments2 = query.list();
